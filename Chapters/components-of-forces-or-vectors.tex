...
\begin{example} \label{ex:block-on-plane-no-forces}
    A block of mass $20kg$ is on a smooth slope of incline $20^\circ$, as in Figure \ref{fig:block-on-plane-no-forces}
    \begin{figure}[H]
        \centering
...
\begin{solution}
    \begin{enumerate}
        ...
        For demonstration purposes, we will also resolve the force $R$ in the direction of the slope. In this case, we have the component of $R$ in the axis of the slope is $R \cos 90^\circ$, but this is $zero$ since $\cos 90^\circ=0$. 
