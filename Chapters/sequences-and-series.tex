...
An arithmetic sequence is one in which the distance between consecutive points is the same:
...
A geometric sequence is one in which the ratio between consecutive points is the same:
...
A general geometric series with $n$ terms looks like the following:
...
Why would we do this? It turns out that subtracting the two simplifies our lives greatly:
