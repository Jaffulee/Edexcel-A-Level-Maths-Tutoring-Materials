...
Using something called the Taylor expansion of trigonometric functions, we can see how each of the functions behave near $0$.
...
From this, you get the small angle approximations of the trigonometric functions.\footnote{This technically requires that $x$ is in radians too, but we will assume that in this section.}
...
Note that if you remember only two of them, a handy way of remembering the third is by rearranging 
...
This can be used to get approximate solutions to problems, but only holds when the argument of the trigonometric functions is close to zero!
...
\begin{solution}
    ...
    \begin{align*}
         ...
         &= \left[\frac{\sqrt{2}}{2}x\right]_{x=0.05}^{x=0.1} + \left[ \frac{1}{4}x^2 \right]_{x=0.05}^{x=0.1} \tag{integrating the parts} \\
         &= \frac{\sqrt{2}}{2}\cdot0.1 - \frac{\sqrt{2}}{2}\cdot0.05 +  \frac{1}{4}(0.1)^2 -  \frac{1}{4}(0.05)^2
    \end{align*}
