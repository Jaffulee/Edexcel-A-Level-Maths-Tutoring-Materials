...
More rigoroously, it is the maximum probability (in the case of one tail) we are allowing for an event to occur under the null hypothesis. For a two-tailed tests, we consider it as two one-tailed tests with half the allowed maximum probability.
