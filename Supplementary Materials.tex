...
\begin{solution}
    ...
    \begin{align*}
         \int_{-0.05}^{0.1} x\frac{\cos(x)}{\sqrt{2}x - \sin(x^2)} dx &= \int_{-0.05}^{0.1} \frac{2 + \sqrt{2}x}{2} dx \\
         &= \int_{-0.05}^{0.1} 1dx + \int_{-0.05}^{0.1}  \frac{\sqrt{2}x}{2} dx \tag{splitting the integral} \\
         &= \left[x\right]_{x=-0.05}^{x=0.1} + \left[ \frac{\sqrt{2}}{4}x^2 \right]_{x=-0.05}^{x=0.1} \tag{integrating the parts} \\
         &= 0.1 - 0.05 +  \frac{\sqrt{2}}{4}(0.1)^2 -  \frac{\sqrt{2}}{4}(0.05)^2
    \end{align*}
