...
Parametric equations are when you are given multiple equations which use shared variables, and are to be calculated from the shared variables.
...
You will be normally asked to find $y$ in terms of $x$. 
From here, there are a two main approaches:
\begin{enumerate}
...
\begin{example}
    ...
    \begin{align*}
        ...
        y &= 4t - 5 + \frac{3}{t}, \; t\neq 0
    \end{align*}
    Let $x \neq1$. Then show that the curve satisfied by the above equations can be written as:
...
\begin{solution}
    ...
    \begin{align*}
        y &= 4t - 5 + \frac{3}{t} \\
         ...
         &= \frac{2x^2-9x+3}{(x-1)} \tag{simplifying}
    \end{align*}
    Which finishes the question, finding $a=2$, $b=-9$, and $c=3$ so that 
    \[y = \frac{ax^2 + bx + c}{x-1} = \frac{2x^2+(-9)x+3}{(x-1)} \]
...
\begin{example}
    ...
    \end{align*}
    Show that the curve satisfied by the above equations can be written as:
...
\begin{example}
    ...
    Comment on whether the the final function is the same as the curve for all $x$.
\end{example}
...
\begin{example}
    ...
    \begin{align*}
        ...
        y &= \frac{1}{t^4} + t^8
    \end{align*}
    Using small angle approximations, show that the curve satisfied by the above equations can be written as:
...
\begin{align*}
    \vert \vec{v} \vert = \sqrt{\sqrt{a^2 + b^2} + c^2} = \sqrt{a^2 + b^2 + c^2}
\end{align*}
