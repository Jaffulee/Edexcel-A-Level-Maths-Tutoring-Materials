...
To do this, we will have two hypotheses, the original baseline hypothesis that we assume to be true, called the \emph{null hypothesis}, and the \emph{alternative hypothesis}, which is usually ``not the null hypothesis'' or something a directional version of not (like more than or less than).
